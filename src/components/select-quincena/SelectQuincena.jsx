...
import styles from "./select-quincena.module.css";
    ...
    return (
        <>
            <select
                ...
                value={year}
                className={`${styles["selects"]} ${styles["year-select"]}`}
            >
            ...
            <select
                ...
                value={month}
                className={`${styles["selects"]} ${styles["month-select"]}`}
            >
                <option value="" disabled>
                    Mes
                </option>
            ...
            <select
                ...
                value={fortnight}
                className={`${styles["selects"]} ${styles["quincena-select"]}`}
            >
                <option value="" disabled>
                    Quincena
                </option>
